...
class Qqv2_api implements api_login {
	...
	public function get_api_url()
	{
		...
		//http://localhost/system/api_login/qqv2/qq_login.php
		$url = SITE_DOMAIN.APP_ROOT."/system/api_login/qq/oauth/qq_login.php";	
	...
	public function create_user()
	{
		...
		if($rs > 0)
		{
			...
			if($register_redbag > 0){
				require_once(APP_ROOT_PATH."system/libs/user.php");
				modify_account(array('money'=>$register_redbag,'nmc_amount'=>$register_redbag),intval($user_id),"在".to_date(TIME_UTC)."注册成功,送红包",18);
			}
		}
