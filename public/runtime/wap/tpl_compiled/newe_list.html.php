...
?>" />
<!--投资借款列表-->
<?php $_from = $this->_var['data']['newe']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'deal');if (count($_from)):
...
?>
    <div class="container" style="border-bottom: 1px solid #ccc;">
        ...
        <div class="row">
            <a href="<?php
echo parse_wap_url_tag("u:index|newe|"."id=".$this->_var['deal']['id']."".""); 
?>">
