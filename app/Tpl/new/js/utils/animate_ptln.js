...
$(document).ready(function() {
	var PRNG = function( exports ) {
		function setSeed( seed ) {
			// Create a length 200 array to store the state of the generator
			exports.MT = new Uint32Array( 200 );
			exports.index = 0;
			exports.MT[ 0 ] = seed;
			for( var i = 1 ; i < 200; i++ ) {
		...
		function extractNumber() {
			...
			exports.index = ( exports.index + 1 ) % 200;
			return y;
		}

		function generateNumbers() {
			for( var i = 0; i < 200; i++ ) {
				var y = ( exports.MT[ i ] & 0x80000000 ) + ( exports.MT[( i + 1 ) % 200 ] & 0x7fffffff );
				exports.MT[ i ] = exports.MT[ ( i + 397 ) % 200] ^ ( y >> 1 );
				if ( y % 2 != 0 ) {
	...
	document.getElementById('aboutus_link').appendChild( canvas );
